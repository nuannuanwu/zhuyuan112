...
function cookbookSave(y,m,d){
	...
	cookbookPost('save',date,breakfast,light_breakfast,lunch,light_lunch,dinner,light_dinner);	
}
//关闭食谱
...
//AJAX递交食谱至后端
function cookbookPost(type,date,breakfast,light_breakfast,lunch,light_lunch,dinner,light_dinner){
	data = { date:date,school:SCHOOL,group:GROUP,breakfast:breakfast,light_breakfast:light_breakfast,lunch:lunch,light_lunch:light_lunch,dinner:dinner,light_dinner:light_dinner };
	url='save_cookbook/';	
